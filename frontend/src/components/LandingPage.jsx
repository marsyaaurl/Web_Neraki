    ...
    <main className=" scroll-smooth">
      ...
      <section id="home">
        <ContainerLandingPage className=" flex flex-col gap-2.5 my-6 md:my-10 mx-4 items-center">
          ...
          <p className="flex  sm:text-lg text-center  break-words sm:max-w-2xl ">
            {
              "Dengan Neraki, temukan UMKM favoritmu secara cepat dan mudah. Satu platform untuk mencari, mengenal, dan mendukung brand lokal agar terus berkembang di era digital."
            }
          </p>
      ...
      <section id="about">
        <ContainerLandingPage className=" bg-blue px-10 py-6 md:px-28 md:py-10 lg:px-40 flex flex-col gap-5">
          ...
          <p className=" text-base  text-white">
            {
              "Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae atque cumque ut quasi et necessitatibus quis porro ab ullam inventore. Debitis ullam soluta a nostrum minus numquam eos eum fugit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse inventore deleniti, facilis quibusdam ipsum minus praesentium ut neque ipsam delectus rerum velit soluta ipsa sequi quod perspiciatis corporis. Voluptas, mollitia. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit debitis aut hic quidem enim consectetur quas totam, omnis id exercitationem, voluptatum, nobis numquam. Quis perferendis id accusantium voluptates dolore modi."
            }
          </p>
        </ContainerLandingPage>
      </section>
      <section id="feature">
        <ContainerLandingPage>
          <div className=" bg-yellow py-6 px-10  md:px-28 md:py-5 lg:px-40  lg:py-5">
            <h1
              className=" text-4xl font-extrabold text-blue 
        "
            >
          ...
          <div className=" flex flex-col lg:flex-row  justify-between gap-8 mx-10 my-10 ">
            <div className=" bg-blueLight flex flex-col items-center gap-8 p-7 rounded-3xl shadow-sm">
              <div className=" w-fit p-4 rounded-full border-blue border-4 bg-white">
                <MapPinned size={54} color="#374F86" />
              </div>

              <div className=" flex flex-col items-center gap-2">
                <h1 className=" text-xl text-center font-medium break-words text-blue">
                  Pencarian UMKM Terdekat + <br /> Peta Interaktif
                </h1>
            ...
            <div className=" bg-blueLight flex flex-col items-center gap-8 p-7 rounded-3xl shadow-sm">
              <div className=" w-fit p-4 rounded-full border-blue border-4 bg-white">
                <Sparkles size={54} color="#374F86" />
              </div>
              <div className=" flex flex-col items-center gap-2">
                <h1 className=" text-xl text-center font-medium text-blue">
                  Filter Pintar + Dinamis
                </h1>
                <p className=" text-justify text-blue">
                  {
            ...
            <div className=" bg-blueLight flex flex-col items-center gap-8 p-7 rounded-3xl shadow-sm">
              <div className=" w-fit p-4 rounded-full border-blue border-4 bg-white">
                <Store size={54} color="#374F86" />
              </div>
              <div className=" flex flex-col items-center gap-2">
                <h1 className=" text-xl text-center font-medium text-blue">
                  Profil UMKM + Kontak Langsung
                </h1>
                <p className=" text-justify text-blue">
                  {
      ...
      <section id="contact">
        <ContainerLandingPage className=" px-10 mb-12 md:px-28 lg:px-40 flex flex-col  gap-5">
          <h1 className=" text-4xl font-extrabold text-blue">
            Lihat Lebih Dekat
          </h1>
